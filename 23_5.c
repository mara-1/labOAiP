...
char filenameIn[] = "d:\\OAIPproject\\Lab№23\\text5.txt";
char filenameHTML[] = "d:\\OAIPproject\\Lab№23\\text5_out.html";
...
void main() {
	...
	int ch;
	while ((ch = getc(fin)) != EOF) { //читаем из файла посимвольно пока не конец файла
